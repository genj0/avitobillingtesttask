...
$(function(){
  ...
  $(".number").keyup(function(event){
    ...
    if($(this).val().length > 12){
      $(".card_number").text($(this).val().slice(0, 4) + " " +$(this).val().slice(4, 8) + " " +$(this).val().slice(8,12) + " " +$(this).val().slice(12));
    }else
      if($(this).val().length > 8){
        $(".card_number").text($(this).val().slice(0, 4) + " " +$(this).val().slice(4, 8) + " " +$(this).val().slice(8));
      }else
        if($(this).val().length > 4){
          $(".card_number").text($(this).val().slice(0, 4) + " " +$(this).val().slice(4));
        }else{
          $(".card_number").text($(this).val());
        }
    number = $(this).val();
